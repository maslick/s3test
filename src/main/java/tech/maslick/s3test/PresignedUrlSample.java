...
import tech.maslick.s3test.auth.AWS4SignerForQueryParameterAuth;
...
public class PresignedUrlSample {
     ...
     */
    public static void getPresignedUrlToS3Object(String bucketName, String key, String regionName, String awsAccessKey, String awsSecretKey) {
        System.out.println("******************************************************");
        ...
        AWS4SignerForQueryParameterAuth signer = new AWS4SignerForQueryParameterAuth(endpointUrl, "GET", "s3", regionName);
