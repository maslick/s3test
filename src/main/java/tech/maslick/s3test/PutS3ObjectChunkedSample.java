...
import tech.maslick.s3test.auth.AWS4SignerForChunkedUpload;
...
public class PutS3ObjectChunkedSample {
    ...
    private static final String contentSeed = "chunked";
    
    /**
     * Uploads content to an Amazon S3 object in a series of signed 'chunks' using Signature V4 authorization.
     */
    public static void putS3ObjectChunked(String bucketName, String key, String regionName, String awsAccessKey, String awsSecretKey) {
        System.out.println("***************************************************");
